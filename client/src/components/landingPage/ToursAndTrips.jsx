...
export const ToursAndTrips = () => {
  ...
  const visibleItems = TRIPS_AND_TOURS.slice(
    currentIndex,
      ...
      <div className="relative px-1 mx-1 lg:px-5 lg:mx-2 overflow-hidden">
        {TRIPS_AND_TOURS.length > itemsToShow && (
          <>
            <button
              onClick={prevSlide}
              className="absolute left-1 top-1/2 -translate-y-1/2 bg-gray-200 rounded-full shadow-md p-1 sm:p-2 z-10 hover:scale-105 sm:hover:scale-110 hover:bg-white"
            ...
            <button
              onClick={nextSlide}
              className="absolute right-1 top-1/2 -translate-y-1/2 bg-gray-200 rounded-full shadow-md p-1 sm:p-2 z-10 hover:scale-105 sm:hover:scale-110 hover:bg-white"
              aria-label="Previous tours"
            >
...
const ToursAndTripsCard = ({ trip }) => {
  return (
    <div
      className="bg-white rounded-lg shadow-gray-600 shadow-md overflow-hidden hover:shadow-lg 
    ...
    >
      ...
      <div className="p-3 sm:p-4">
        ...
        <button
          className="w-full mt-4 px-4 py-2 rounded-md text-white font-bold bg-yellow-600
              transition-all duration-300 hover:bg-yellow-400
              cursor-pointer hover:text-gray-600 whitespace-nowrap"
        >
          CHECK OUT NOW
        </button>
      </div>
