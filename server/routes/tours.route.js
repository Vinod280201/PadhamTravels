// routes/tours.route.js
import express from "express";
import { authenticate } from "../middlewares/authenticate.js";
import { authorizeAdmin } from "../middlewares/adminAuthenticate.js";

const router = express.Router();
console.log(">>> TOURS ROUTER LOADED FROM:", import.meta?.url || __filename);

// Temporary in‑memory store. Replace with DB model later.
let tours = [];
console.log("Tours router loaded");

// ✅ All /api/tours routes require a valid JWT + admin role
router.use(authenticate, authorizeAdmin);

// GET /api/tours - list all tours
router.get("/", (req, res) => {
  console.log("GET /api/tours hit");
